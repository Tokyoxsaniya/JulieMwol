...
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/Tokyo.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
 ...
 await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/Vishnu.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        ...
        if (!!message.mention && message.mention[0] == '917907682535@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/Abhijit.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
